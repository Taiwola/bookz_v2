const Newsletter = () => {
    return (
        ...
        className="rounded-[9px] border border-[#ccc] placeholder-[#FAF8F8] placeholder:font-[600] placeholder:text-[12px] w-full outline-none box-border text-[#FAF8F8] bg-transparent py-[15px] px-12"
    />
